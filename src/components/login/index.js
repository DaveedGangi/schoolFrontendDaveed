...
class Login extends Component {
    ...
    submitLogin=async(e)=>{
        ...
        const url="https://schoolbackenddaveed.onrender.com/login"
        const options={
            method:"POST",
            headers:{
        ...
        if(response.ok){
            ...
            const {jwtToken,username,role,id}=responseToJson
    ...
    submitNewUserDetails=async(e)=>{
        ...
        const {newUserName,newUserPassword,confirmPassword,role}=this.state
        const data={name:newUserName,password:newUserPassword,role:role}
        ...
        if(newUserPassword!==confirmPassword){
            ...
            const url="https://schoolbackenddaveed.onrender.com/register"
            const options={
                method:"POST",
                headers:{
                    "Content-Type":"application/json"
                    ...
                    {register===false?
                        ...
                        <form onSubmit={this.submitNewUserDetails} id="registerForm" className="form">
                            ...
                            <div className="form-group">
                                ...
                                <select onChange={this.changeTheRoles} className="select-options" id="role" name="role">
